...
- [ ] Exercised against a real PlayStation Network account, for a monitoring, authentication or data-handling change

<!-- A monitoring or authentication change is not verified by the offline suite alone, which never
     contacts PlayStation Network. Say what you ran it against, without usernames or credentials. -->
...
<!-- Never include NPSSO tokens, SMTP passwords or webhook URLs or the accounts you monitor in a pull request. -->
