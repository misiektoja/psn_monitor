...
psn_monitor original code is licensed under GPL-3.0-or-later. See [LICENSE](LICENSE).
...
| --- | --- | --- |
| [PSNAWP](https://pypi.org/project/PSNAWP/) | MIT | PlayStation Network API client for presence, games and trophies |
...
The tool contacts PlayStation Network. Optional notification delivery contacts the SMTP server or webhook endpoint you configure. Nothing is sent anywhere you have not configured.
